...
#ifndef YCSWIFTSIGNATUREVIEW_SWIFT_H
#define YCSWIFTSIGNATUREVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="YCSwiftSignatureView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20YCSwiftSignatureView18SwiftSignatureView")
@interface SwiftSignatureView : UIView <UIGestureRecognizerDelegate>
...
@property (nonatomic) IBInspectable CGFloat strokeAlpha;
